package DesignPatterns.Games.SnakeLadder;
...
//    private Map<Integer, Player> playerIdMapping;
    ...
    public static class GameBuilder {
        ...
        public Game build() {
//            Map<Integer, Player> playerIdMapping = new HashMap<>();
//            this.players.stream().forEach(player -> {
//                playerIdMapping.put(player.getPlayerId(), player);
//            });
